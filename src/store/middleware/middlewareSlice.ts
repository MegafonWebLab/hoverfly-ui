...
export const middlewareSlice = createSlice<IMiddlewareState, {}, 'middleware'>({
    ...
    extraReducers: builder => {
        builder
            ...
            .addCase(getMiddlewareAsync.rejected, defaultRejectedCase<IMiddlewareState, Middleware>())
            ...
            .addCase(updateMiddlewareAsync.rejected, defaultRejectedCase<IMiddlewareState, Middleware>());
    },
});
